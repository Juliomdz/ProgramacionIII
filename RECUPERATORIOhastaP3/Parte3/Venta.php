...
class Venta{
    ...
    public function __construct ($id = NULL, $mailUsuario = NULL, $nombreHamburguesa = NULL, $tipoHamburguesa = NULL,$aderezo = NULL, $numero = NULL, $cantidad = NULL, $fechaAlta = NULL)
    {
        $this->id = intval($id);
        $this->mailUsuario = $mailUsuario;
        $this->nombreHamburguesa = strtolower($nombreHamburguesa);
        $this->tipoHamburguesa = strtolower($tipoHamburguesa);
        $this->aderezo = strtolower($aderezo);
    ...
    static public function PrintList($arr){
        if(!is_null($arr) && is_array($arr) && count($arr) > 0){
            ...
            foreach ($arr as $value) {
                ...
                echo '<li>'. 'Aderezo: ' . $value->aderezo .'</li>';
    ...
    public function InsertIntoDB($objAD)
    {
        try
        {
            if(!is_null($objAD) && !is_null($this)){
                ...
                $sentencia->bindValue(4, $this->aderezo, PDO::PARAM_STR);
                $sentencia->bindValue(5, $this->numero, PDO::PARAM_INT);
                $sentencia->bindValue(6, $this->cantidad, PDO::PARAM_INT);
                $sentencia->bindValue(7, $this->fechaAlta, PDO::PARAM_STR);
    ...
    */
    ...
    public function UpdateFields($mailUsuario, $nombreHamburguesa, $tipoHamburguesa, $aderezo, $cantidad){
        $this->mailUsuario = $mailUsuario;
