...
if(isset($_GET['fecha']))
{
    ...
    echo 'A) Cantidad de Hamburguesas vendidas en la fecha especificada: ', $cantidadVendidas, PHP_EOL;
}
...
{
    echo PHP_EOL; echo PHP_EOL;
    $aderezo = $_GET['ketchup'];
    echo 'E) Listado de Ventas con ketchup: '. $aderezo . PHP_EOL;
    $arrVentastipo = Venta::GetAllBy($objAD, 'aderezo', $aderezo);
    Venta::PrintList($arrVentastipo);
}
